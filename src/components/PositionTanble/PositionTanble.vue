<template>
  ...
  >
    ...
    <el-table-column label="Operation" align="center">
      <template slot-scope="scope">
        <el-button v-if="scope.row.status === 0" size="small" type="danger" icon="el-icon-delete" circle
                   @click="changePositionStatus(scope.row.id, scope.$index)"
        />
        <el-button v-if="scope.row.status === 1" size="small" type="success" icon="el-icon-check" circle
                   @click="changePositionStatus(scope.row.id, scope.$index)"
        />
